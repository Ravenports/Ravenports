...
M17N_VERSION=			1.8.4
GLIBC_VERSION=			2.26
GSTREAMER1_VERSION=		1.24.5		# only even (1.16.x, 1.18.x)
GSTREAMER1_GST=			1.0
GSTREAMER1_SOVERSION=		0.2405.0
XORG_VERSION=			7.7
LLVM16_VERSION=			16.0.6		# required for javaports unkindness
LLVM17_VERSION=			17.0.6
LLVM18_VERSION=			18.1.7
ZLIB_VERSION=			1.3.1
